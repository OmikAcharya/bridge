...
export interface ParticleObjectOptions {
  ...
  /** Minimum vertical polar angle in radians (default 0). Restricts how high camera can go. */
  minPolarAngle?: number;
  /** Maximum vertical polar angle in radians (default Math.PI). Restricts how low camera can go. */
  maxPolarAngle?: number;
  /** Minimum horizontal azimuth angle in radians (default -Infinity). Restricts left rotation. */
  minAzimuthAngle?: number;
  /** Maximum horizontal azimuth angle in radians (default Infinity). Restricts right rotation. */
...
const CAMERA_DIR = new THREE.Vector3(1.2, 0.6, 3.2).normalize();
const MODEL_LIFT = 0.0;
...
export function createParticleObject(
  ...
  function applyOptions() {
    ...
    if (config.minAzimuthAngle !== undefined) controls.minAzimuthAngle = config.minAzimuthAngle;
    if (config.maxAzimuthAngle !== undefined) controls.maxAzimuthAngle = config.maxAzimuthAngle;
